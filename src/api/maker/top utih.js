...
module.exports = function (app) {
    app.get('/v1/maker/toputih', async (req, res) => {
        ...
        const fixedPrompt = `A portrait of the person in the image, transformed with pale white skin. The skin should have an ethereal, almost luminous quality. Include subtle details like light grey eyes or silvery hair for contrast. Focus on the delicate features.`;
