...
module.exports = function (app) {
    app.get('/v1/maker/tomasker', async (req, res) => {
        ...
        const fixedPrompt = `A close-up portrait of the person, with the lower half of their face covered by a mask. Specify the type of mask: a black cloth mask, a medical-style mask, or a stylish designer mask. The texture and material of the mask should be clear. Their eyes and expression above the mask should remain recognizable.`;
